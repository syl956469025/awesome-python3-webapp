...
class LongField(Field):
    def __init__(self, name=None, primary_key=False, default=0, ddl='bigint'):
        super(LongField, self).__init__(name, ddl, primary_key, default)


class BooleanField(Field):
    def __init__(self, name=None, default=False, ddl='bool'):
        super(BooleanField, self).__init__(name, ddl, False, default)


class FloatField(Field):
    def __init__(self, name=None, default=0.0, primary_key=False, ddl="float"):
        super(FloatField, self).__init__(name, ddl, primary_key, default)


class TextField(Field):
    def __init__(self, name=None, default=None, primary_key=False, ddl="text"):
...
class ModelMetaclass(type):
    def __new__(cls, name, bases, attrs):
        ...
        attrs['__fields__'] = fields  # 除主键意外的属性
